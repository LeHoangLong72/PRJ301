...
public class CategoryDAO {
    ...
    public String getNameCategory(int id_theloai) throws SQLException, ClassNotFoundException {
        String name = "";
        Connection connection = DBUtils.getConnection();
        String query = "SELECT tentheloai FROM theloaigame WHERE visiable = 1 AND id_theloai = ?";
        PreparedStatement ps = connection.prepareStatement(query);
